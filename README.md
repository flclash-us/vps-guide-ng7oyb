# AdBlock Rules for Clash 8fun6y
...
rule-providers:
  adblock:
    type: http
    behavior: domain
    url: "https://raw.githubusercontent.com/flclash-us/adblock-rules-clash-8fun6y/main/rules/ad-domain.yaml"
  ...
  malware:
    type: http
    behavior: domain
    url: "https://raw.githubusercontent.com/flclash-us/adblock-rules-clash-8fun6y/main/rules/malware.yaml"
